...
6. **OWASP security review** — use the `/owasp-asvs` skill to audit changed files for vulnerabilities, memory leaks, buffer overflows, use-after-free, and other C-specific issues. Fix all findings before committing.
